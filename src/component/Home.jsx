        ...
        <div >
            <div className='container-fluid'>
                ...
                <div className='row home-row'>
                    <div className='col-md-6  p-5 ' data-aos="fade-down-left">
                        <h4>
                    ...
                    <div className='col-md-6 mt-5 p-5' data-aos="fade-down-right" >
            ...
            <div className='container-fluid body'>
                <div className='row d-flex justify-content-center ' >
                    <div className='col-md-5 card-home' data-aos="fade-left">
            ...
            <div className='container mt-4 mb-5'>
                <div className='row d-flex justify-content-between'>
                    ...
                    <div className='col-md-6 ' data-aos="fade-right">
                        ...
                        <div className='row home-section-1-row-2' data-aos="fade-right">
                    ...
                    <div className='col-md-6 border-start'data-aos="fade-left">
