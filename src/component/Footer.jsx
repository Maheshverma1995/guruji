                ...
                <div className='container '>
                    <div className="row">
                        <div className='col-md-4 mt-5 data-aos="fade-up-right"'>
                            <h1 data-aos="fade-up-right" > डायरी</h1>
                            <div className='row'>
                                ...
                                <div className='col-md-8 '>
                                    <p data-aos="fade-up">बीजांकुर न्याय के समान श्रुतज्ञान की परम्परा और आचार्यपरम्परा एक दूसरे के पूरक हैं। आचरंति यस्माद् व्रतानी त्याचार्यः ।।3।। यस्माद् सम्यग्ज्ञानादि गुणाधारा हृदय व्रतानि स्वर्गापवर्ग सुखामृत बीजानि भव्या हितार्थ माचरति स आचार्यः |</p>
                                </div>
                        ...
                        <div className='col-md-4 mt-5'data-aos="fade-up">
                            <h1 data-aos="fade-up-left"> नवीनतम समाचार </h1>
                            <div className='col'>
