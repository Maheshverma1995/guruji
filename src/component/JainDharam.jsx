        ...
        <div className='body'>
            ...
            <div className='container mt-5 mb-5'>
                ...
                <div className='row'>
                    ...
                    <button className='btn btn-danger ' style={{ width: '200px', marginTop: '80px', height: '60px' }}>और पढ़ें</button>
                    ...
                    <div className='col-md-6'>
                        <div class="card bg-dark text-white">
                            ...
                            <div class="card-img-overlay d-flex align-items-center justify-content-center">
                                <button className='btn btn-danger  ' style={{ width: '200px', height: '60px' }}>और पढ़ें</button>
